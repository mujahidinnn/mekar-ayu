      ...
      <div className="space-y-5 pb-4">
        ...
        <div className="flex gap-3 rounded-2xl bg-rose-50 p-3 dark:bg-stone-800">
          ...
          <p className="text-xs leading-relaxed text-rose-900/70 dark:text-stone-300">
            <span className="font-semibold text-rose-950 dark:text-rose-50">File ini tidak terenkripsi.</span> Isinya berupa teks biasa yang bisa
            dibaca siapa saja yang membukanya — simpan di tempat pribadi, jangan bagikan atau unggah ke folder publik.
          </p>
        </div>
      </div>
    </Sheet>
